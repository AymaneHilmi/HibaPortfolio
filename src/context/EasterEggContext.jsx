...
export const EasterEggProvider = ({ children }) => {
  ...
  const [links, setLinks] = useState([
    ...
    { name: "Email", path: `mailto:contact@hibarahilsoussah.com` },
    {
      name: "LinkedIn",
      path: "https://www.linkedin.com/in/hiba-rahil-soussah-73616b214/",
      external: true,
    }
  ]);
  ...
  toast.custom(
    (t) => (
      ...
      >
        ...
        <div className="flex items-center justify-center px-4 bg-brandgradient text-white font-extrabold text-2xl rounded-l-xl">
          i
        </div>
